...
#
# test-hfc-app — Mode 1 behavior test
#
# Generated by /hubitat-behavior-test from apps/tests/spec-humidity-fan-controller.yaml.
# Edit the spec and re-run the skill to regenerate this file. Manual edits
# will be overwritten.
#
# Usage:
#   bash apps/tests/test-humidity-fan-controller.sh                             # default hub
#   bash apps/tests/test-humidity-fan-controller.sh @hubname                    # specific hub
#   bash apps/tests/test-humidity-fan-controller.sh @hubname 247                # specific hub + explicit instance id
#
# Runtime budget: ~70s. Tests exceeding this must opt into RUN_SLOW_TESTS=1 per TESTING.md §1.1.
#
...
APP_TYPE_NAME         = "Humidity-Based Fan Controller"
APP_INSTANCE_LABEL    = "test-hfc-app"
MAKER_API_LABEL       = "test-hfc-maker"
INPUT_DEVICE_LABELS   = ["test-hfc-bath", "test-hfc-ref", "test-hfc-restrict", "test-hfc-motion"]
OUTPUT_DEVICE_LABELS  = ["test-hfc-fan", "test-hfc-hi-sw"]
CASES                 = [{'name': 'baseline-normal', 'setup': [{'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [45]}, {'device': 'test-hfc-ref', 'command': 'setHumidity', 'args': [50]}, {'device': 'test-hfc-restrict', 'command': 'off'}, {'device': 'test-hfc-fan', 'command': 'off'}, {'device': 'test-hfc-hi-sw', 'command': 'off'}], 'wait_seconds': 4, 'assert': [{'device': 'test-hfc-fan', 'attribute': 'switch', 'value': 'off'}, {'device': 'test-hfc-hi-sw', 'attribute': 'switch', 'value': 'off'}]}, {'name': 'activate-via-offset', 'actions': [{'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [75]}], 'wait_seconds': 4, 'assert': [{'device': 'test-hfc-fan', 'attribute': 'switch', 'value': 'on'}, {'device': 'test-hfc-hi-sw', 'attribute': 'switch', 'value': 'on'}]}, {'name': 'cancel-pending-deactivation', 'actions': [{'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [60]}, {'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [75]}], 'command_spacing_seconds': 1.0, 'wait_seconds': 2, 'assert': [{'device': 'test-hfc-fan', 'attribute': 'switch', 'value': 'on'}, {'device': 'test-hfc-hi-sw', 'attribute': 'switch', 'value': 'on'}], 'assert_logs': [{'pattern': 'Humidity rose during deactivation delay', 'level': 'info'}]}, {'name': 'deactivate-via-snapshot', 'actions': [{'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [60]}, {'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [60]}], 'command_spacing_seconds': 1.0, 'wait_seconds': 4, 'assert': [{'device': 'test-hfc-fan', 'attribute': 'switch', 'value': 'off'}, {'device': 'test-hfc-hi-sw', 'attribute': 'switch', 'value': 'off'}]}, {'name': 'cancel-pending-activation', 'actions': [{'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [75]}, {'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [45]}], 'command_spacing_seconds': 1.0, 'wait_seconds': 2, 'assert': [{'device': 'test-hfc-fan', 'attribute': 'switch', 'value': 'off'}, {'device': 'test-hfc-hi-sw', 'attribute': 'switch', 'value': 'off'}], 'assert_logs': [{'pattern': 'Humidity dropped during activation delay', 'level': 'info'}]}, {'name': 'absolute-high-bypass', 'actions': [{'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [75]}, {'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [95]}], 'command_spacing_seconds': 1.0, 'wait_seconds': 0.5, 'assert': [{'device': 'test-hfc-fan', 'attribute': 'switch', 'value': 'on'}, {'device': 'test-hfc-hi-sw', 'attribute': 'switch', 'value': 'on'}], 'assert_logs': [{'pattern': 'bypassing activation delay', 'level': 'info'}]}, {'name': 'countermand-pending-on', 'actions': [{'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [60]}, {'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [75]}, {'device': 'test-hfc-fan', 'command': 'off'}], 'command_spacing_seconds': 1.0, 'wait_seconds': 2, 'assert': [{'device': 'test-hfc-fan', 'attribute': 'switch', 'value': 'off'}, {'device': 'test-hfc-hi-sw', 'attribute': 'switch', 'value': 'on'}], 'assert_logs': [{'pattern': 'Pending ON countermanded by external OFF event', 'level': 'info'}, {'pattern': 'Fan failed to turn on', 'level': 'error', 'negate': True}]}, {'name': 'restriction-blocks-activation', 'setup': [{'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [45]}, {'device': 'test-hfc-restrict', 'command': 'on'}], 'setup_wait_seconds': 3, 'actions': [{'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [75]}], 'wait_seconds': 4, 'assert': [{'device': 'test-hfc-fan', 'attribute': 'switch', 'value': 'off'}, {'device': 'test-hfc-hi-sw', 'attribute': 'switch', 'value': 'on'}]}, {'name': 'restriction-lifted-while-high', 'actions': [{'device': 'test-hfc-restrict', 'command': 'off'}], 'wait_seconds': 3, 'assert': [{'device': 'test-hfc-fan', 'attribute': 'switch', 'value': 'on'}, {'device': 'test-hfc-hi-sw', 'attribute': 'switch', 'value': 'on'}], 'assert_logs': [{'pattern': 'Restriction lifted while humidity is high', 'level': 'info'}]}, {'name': 'cleanup-to-baseline', 'actions': [{'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [45]}], 'wait_seconds': 4, 'assert': [{'device': 'test-hfc-fan', 'attribute': 'switch', 'value': 'off'}, {'device': 'test-hfc-hi-sw', 'attribute': 'switch', 'value': 'off'}]}, {'name': 'fast-climb-bypasses-activation-delay', 'setup': [{'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [40]}, {'device': 'test-hfc-ref', 'command': 'setHumidity', 'args': [50]}, {'device': 'test-hfc-restrict', 'command': 'off'}, {'device': 'test-hfc-fan', 'command': 'off'}, {'device': 'test-hfc-hi-sw', 'command': 'off'}, {'device': 'test-hfc-motion', 'command': 'active'}], 'setup_wait_seconds': 4, 'actions': [{'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [50]}, {'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [65]}, {'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [75]}], 'command_spacing_seconds': 0.7, 'wait_seconds': 1, 'assert': [{'device': 'test-hfc-fan', 'attribute': 'switch', 'value': 'on'}, {'device': 'test-hfc-hi-sw', 'attribute': 'switch', 'value': 'on'}], 'assert_logs': [{'pattern': 'Fast humidity climb detected', 'level': 'info'}, {'pattern': 'bypassing activation delay', 'level': 'info'}]}, {'name': 'occupancy-gate-blocks-fast-climb', 'setup': [{'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [40]}, {'device': 'test-hfc-motion', 'command': 'inactive'}, {'device': 'test-hfc-fan', 'command': 'off'}, {'device': 'test-hfc-hi-sw', 'command': 'off'}], 'setup_wait_seconds': 4, 'actions': [{'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [50]}, {'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [65]}, {'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [75]}], 'command_spacing_seconds': 0.7, 'wait_seconds': 1, 'assert': [{'device': 'test-hfc-fan', 'attribute': 'switch', 'value': 'off'}, {'device': 'test-hfc-hi-sw', 'attribute': 'switch', 'value': 'off'}], 'assert_logs': [{'pattern': 'Fast humidity climb detected', 'level': 'info', 'negate': True}]}, {'name': 'excessive-change-bypasses-from-normal', 'setup': [{'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [30]}, {'device': 'test-hfc-ref', 'command': 'setHumidity', 'args': [50]}, {'device': 'test-hfc-restrict', 'command': 'off'}, {'device': 'test-hfc-fan', 'command': 'off'}, {'device': 'test-hfc-hi-sw', 'command': 'off'}], 'setup_wait_seconds': 4, 'actions': [{'device': 'test-hfc-bath', 'command': 'setHumidity', 'args': [92]}], 'wait_seconds': 0.5, 'assert': [{'device': 'test-hfc-fan', 'attribute': 'switch', 'value': 'on'}, {'device': 'test-hfc-hi-sw', 'attribute': 'switch', 'value': 'on'}], 'assert_logs': [{'pattern': 'Excessive humidity change', 'level': 'info'}, {'pattern': 'bypassing activation delay', 'level': 'info'}]}]
